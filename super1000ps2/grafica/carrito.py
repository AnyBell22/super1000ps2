...
class Carrito(tk.Frame):
    def __init__(self, root):
        ...
        self.editar=tk.Button(self.frame2,text="Vaciar Carrito",command=self.vaciar_carrito)
        self.eliminar=tk.Button(self.frame2,text="Confirmar Compra",command=self.confirmarCompra)
        self.agregar=tk.Button(self.frame2,text="Agregar Producto",command=self.agregar_carrito)
