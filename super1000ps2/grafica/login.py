...
class Login:
    def __init__(self, root):
        ...
        #Para bloquear el agrandar o achicar la ventana (ancho,alto).
        #Se coloca 0 o 1.
        ...
        self.titulo=tk.Label(self.frame1, text="Supermark \nBienvenido")
        ...
        #Creo StringVar para administrar las entradas
        self.sUsuario=tk.StringVar()
        self.sPass=tk.StringVar()
                
        #Creo los widgets
        self.usuario=tk.Label(self.frame2, text="Correo \nElectronico")
        self.usuario.config(font=font_f2)
        self.usuario.place(x=10,y=10,width=70,height=30)
