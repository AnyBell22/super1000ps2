...
class Lista(tk.Frame):
    def __init__(self, root):
        ...
        self.editar=tk.Button(self.frame2,text="Editar",command=self.editar_producto)
        self.eliminar=tk.Button(self.frame2,text="Eliminar",command=self.eliminar_producto)
        self.agregar=tk.Button(self.frame2,text="Nuevo",command=self.agregar_producto)
    ...
    def editar_producto(self):
        ...
        text=self.tree.item(item)["text"] #Para que ponga el id
        datos.insert(0,text)
        print("viejo",datos)
    ...
    def agregar_producto(self):
        v=Carga(tk.Tk(), "Nuevo Producto", "Carga del Producto", self)
